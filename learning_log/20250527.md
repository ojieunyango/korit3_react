...
설치 끝나고나면
git add .
git commit -m "feat: react router app created"
git push
...
components 폴더를 생성하시고 Home.tsx / Contact.tsx를 만들고 초기화 과정을 작성하겠습니다.
...
mui통해서 input 관련, 배열 관련, Container 컴포넌트 이용해서 중앙 배치 등을 했습니다. Dialog 관련

28일 수업으로는

ch6 생성해서 스프링부트 RESTful 웹 서비스를 위한 프론트엔드 설정을 할 예정입니다.

UI 모형도 제작할거고, 백엔드도 준비된거 설정할겁니다(전에 마지막 날에 결석하신 분들 있어서 제 프로젝트로 통일해서 진행할 예정입니다)
새 리액트 프로젝트 생성해서 작성 시작할 겁니다.

프론트엔드 상에서의 CRUD 기능

git add .
git commit -m "feat: 20250527 AG Grid / MUI / Router"
git push